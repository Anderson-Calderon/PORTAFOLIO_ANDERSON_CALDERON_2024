      ...
      >
        ...
        <main className="md:pl-16 pb-5 ">
          ...
          <section className="galeria-portafolio mb-10">
           ...
           <Link href="https://cardwest.pe/" target="_blank">
              ...
              <div className="contenedor-imagen">
                 ...
                 <div className="ver">
                  ...
                  <Image   src="/imagenes/cardwest.webp"  className="imagen-portafolio" width={400} height={200} alt="Imagen Proyecto" alt="Imagen de ecommerce cardwest" />
